migrate((app) => {
  ...
  const topics = new Collection({
    ...
    fields: [
      ...
      { type: "number", name: "topic_order", min: 0, onlyInt: true },
      ...syncFields,
    ],
    indexes: [
  ...
  const examples = new Collection({
    ...
    fields: [
      ...
      { type: "text", name: "video_title", max: 500 },
      { type: "number", name: "video_start", min: 0, onlyInt: true },
      { type: "text", name: "image_ref", max: 500 },
      { type: "text", name: "audio_ref", max: 500 },
      { type: "text", name: "note", max: 2000 },
      { type: "text", name: "matched_form", max: 240 },
      { type: "text", name: "matched_translation_form", max: 240 },
  ...
  const imagePrompts = new Collection({
    ...
    fields: [
      ...
      { type: "text", name: "image_ref", max: 500 },
      { type: "text", name: "image_model_id", max: 240 },
      ...syncFields,
    ],
    indexes: [
