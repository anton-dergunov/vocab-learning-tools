...
# name a *provider* account: `docs/operations/vertex-setup.md` tells the owner to bind an IAM role
# to their Google login, and `learner@account.example.com` there would be worse than useless — it
