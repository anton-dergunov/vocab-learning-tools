"""The one-off converter that added `beds`.

**Delete this file together with `scripts/throwaway/add_beds.py`**, once that has run. It is
...
_spec = importlib.util.spec_from_file_location(
    "add_beds", ROOT / "scripts" / "throwaway" / "add_beds.py")
