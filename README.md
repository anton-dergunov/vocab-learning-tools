...
# 📘 VocabGen — Vocabulary Article Processor

**VocabGen** is a small command-line utility for cleaning, organizing, and appending
structured vocabulary entries generated by an LLM into Markdown topic files.
