...
| [`compose-lesson-line/`](compose-lesson-line/README.md) | Does adding `primaryGloss` and `emotion` to the compose prompt thin the rest of the article? | Measured 18 Sep 2026 — results pending | [`docs/plans/lexibeat-integration.md`](../docs/plans/lexibeat-integration.md) |
