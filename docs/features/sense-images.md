...
([`server.md`](../architecture/server.md), "Jobs", revises §09 below). `api/routes/images.py`
...
[`server.md`](../architecture/server.md), "Jobs", replaces the two engines below with one: a
