...
([`jobs.md`](../architecture/jobs.md), revises §09 below). `api/routes/images.py`
...
[`jobs.md`](../architecture/jobs.md), replaces the two engines below with one: a
...
3. **Audio.** Pronunciation ([`pronunciation.md`](pronunciation.md)) inherits all of this — the media directory, the
