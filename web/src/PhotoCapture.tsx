...
/**
 * Photo capture (docs/features/photo-capture.md): take or choose a picture, tap a word on it, read
 * what it means in that sentence, and add it — or fold the sentence into the word you already have.
 *
