 ...
 * rule of `docs/architecture/sync.md`: an external dictionary is not the replica, so a failure here
 * degrades a reference surface rather than losing anything the owner wrote.
 */
