/* ── the ask dock ────────────────────────────────────────────────────────
   ...
   into a sheet. No side pane, ever (`docs/features/article-chat.md` §7.1). The article column is
   780 px and a tablet in portrait is about 834 px, so a docked side pane would cut the article to
