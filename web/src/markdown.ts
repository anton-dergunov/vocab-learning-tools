 ...
 * markdown is written. It is export-only by design (`docs/features/export.md`): reconciling
 * free-form markdown against a structured store is the coupling this application exists to escape,
